...
AddEventHandler("aJobs:ChantierAntiDump", function(_config, _workzone, _WorkerChillPos, _WorkerWorkingPos)
                ...
                while not EnAction and AuTravailleChantier do
                    ...
                    if dstToMarker <= 3.0 and AuTravailleChantier then
                        ...
                        if IsControlJustPressed(1, 51) and dstToMarker <= 3.0 then
                            ...
                            TriggerServerEvent("Chantier:Freetz")
...
Citizen.CreateThread(function()
    TriggerServerEvent("aJobs:ChantierAntiDump")
end)