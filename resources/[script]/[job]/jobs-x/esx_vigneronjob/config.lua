ConfigVigneron = {}
ConfigVigneron.Locale = 'fr'

ConfigVigneron.DrawDistance = 25.0
ConfigVigneron.MaxInService = -1
ConfigVigneron.EnablePlayerManagement = true
ConfigVigneron.EnableSocietyOwnedVehicles = false
