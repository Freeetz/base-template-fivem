ConfigMecano = {}
ConfigMecano.Locale = 'fr'

ConfigMecano.DrawDistance = 25.0
ConfigMecano.MaxInService = -1
ConfigMecano.EnablePlayerManagement = true
ConfigMecano.EnableSocietyOwnedVehicles = false

ConfigMecano.NPCSpawnDistance = 500.0
ConfigMecano.NPCNextToDistance = 25.0
ConfigMecano.NPCJobEarnings = { min = 150, max = 500 }

ConfigMecano.Vehicles = {
	'adder',
	'asea',
	'asterope',
	'banshee',
...
ConfigMecano.Zones = {
	MecanoActions = {
		Pos   = { x = -223.6894, y = -1339.0500, z = 33.9897 },
	...
	Garage = {
		Pos   = { x = -202.1494, y = -1310.6041, z = 30.2965 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	Craft = {
		Pos   = { x = -206.6293, y = -1334.5607, z = 31.3012 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -211.4090, y = -1303.3370, z = 31.2695 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
		Heading = 360.0,
	},
...
for i=1, #ConfigMecano.Towables, 1 do
	ConfigMecano.Zones['Towable' .. i] = {
		Pos   = ConfigMecano.Towables[i],
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = -1
	}
