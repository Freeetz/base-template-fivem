ConfigTaxi                            = {}
ConfigTaxi.DrawDistance               = 25.0
ConfigTaxi.NPCJobEarnings             = {min = 15, max = 40}
ConfigTaxi.MaxInService               = -1
ConfigTaxi.EnablePlayerManagement     = true
ConfigTaxi.EnableSocietyOwnedVehicles = false
ConfigTaxi.Locale = 'fr'

ConfigTaxi.Zones = {
	TaxiActions = {
		Pos     = {x = 915.039, y = -162.187, z = 73.750},
	...
	VehicleDeleter = {
		Pos   = {x = 908.317, y = -183.070, z = 73.300},
