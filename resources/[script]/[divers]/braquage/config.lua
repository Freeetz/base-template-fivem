robberiesConfiguration = {
    ...
    reseller = {
        ...
        locations = {
            ...
            { vector = vector3(307.8546, -906.8060, 29.2936), heading = 82.4658, },
            { vector = vector3(-95.9274, -2229.4604, 7.8117), heading = 289.2210, },
            { vector = vector3(-1604.1462, -832.1296, 10.0762), heading = 323.2931, },
        },
    },

    items = {
        ["TV"] = { name = "Téléviseur", resellerValue = 500, timeToTake = 10 },
        ["CLOTHS"] = { name = "Vêtements", resellerValue = 300, timeToTake = 15 },
        ["CLOTHSRICHE"] = { name = "Vêtements de Luxe", resellerValue = 750, timeToTake = 15 },
        ["ECOMP"] = { name = "Composants électroniques", resellerValue = 200, timeToTake = 4 },
        ["ORANGE"] = { name = "Fruits", resellerValue = 500, timeToTake = 2 },
        ["TELEPHONE"] = { name = "iPhone", resellerValue = 900, timeToTake = 4 },
        ["PORNO"] = { name = "Magasine Pornographique", resellerValue = 250, timeToTake = 1 },
        ["PARFUM"] = { name = "Parfum Channel", resellerValue = 100, timeToTake = 3 },
        ["TV4K60FPS"] = { name = "TV 4K 120FPS", resellerValue = 1000, timeToTake = 15 },
        ["BOITEBIJOUX"] = { name = "Boite a Bijoux", resellerValue = 6000, timeToTake = 20 },
        ["PCPORTABLE"] = { name = "PC De Layz", resellerValue = 600, timeToTake = 10 },
        ["TABLEAU"] = { name = "Tableau Pablo Picasso", resellerValue = 100, timeToTake = 10 },
        ["ECRANMAC"] = { name = "Ecran Mac", resellerValue = 400, timeToTake = 8 },
        ["JAGUAR"] = { name = "Jaguar", resellerValue = 200, timeToTake = 5 },
        ["PERCEUSE"] = { name = "Perceuse", resellerValue = 300, timeToTake = 6 },
        ["DEVICE"] = { name = "Device", resellerValue = 500, timeToTake = 15 },
        ["BOITEOUTILS"] = { name = "Boite a Outils", resellerValue = 400, timeToTake = 8 },
        ["COMPRESSEUR"] = { name = "Compresseur", resellerValue = 400, timeToTake = 12 },
        ["PEINTURE"] = { name = "Peinture", resellerValue = 200, timeToTake = 5 },
        ["CHEVRE"] = { name = "Chevre Mécanique", resellerValue = 300, timeToTake = 10 },
        ["ASPIRATEUR"] = { name = "Aspirateur Mécanique", resellerValue = 300, timeToTake = 6 },
        ["BANSHEE"] = { name = "Tableau Banshee", resellerValue = 400, timeToTake = 8 },
        ["OUTILS"] = { name = "Outils", resellerValue = 240, timeToTake = 5 },
        ["FEUILLECASH"] = { name = "Feuille Cash", resellerValue = 400, timeToTake = 8 },
        ["DOCUMENTS"] = { name = "Documents Labo", resellerValue = 50, timeToTake = 2 },
        ["BILLET"] = { name = "Billet Cash Factory", resellerValue = 50, timeToTake = 2 },
        ["BILLET1"] = { name = "Pile de Cash", resellerValue = 550, timeToTake = 10 },
        ["BILLET2"] = { name = "Billet de Cash Factory", resellerValue = 350, timeToTake = 7 },
        ["PRODUITCOC"] = { name = "Produit Cocaine", resellerValue = 400, timeToTake = 8 },
        ["COCAINA"] = { name = "Cocaine", resellerValue = 200, timeToTake = 4 },
        ["CANNA"] = { name = "Cannabis", resellerValue = 500, timeToTake = 2 },
        ["CANNATRAIT"] = { name = "Cannabis traite", resellerValue = 200, timeToTake = 5 },
        ["DISQUEDUR"] = { name = "Disque Dur", resellerValue = 200, timeToTake = 5 },
        ["TABLEAUPAUVRE"] = { name = "Tableau Décoration", resellerValue = 250, timeToTake = 8 },
        ["BROSSEADENTS"] = { name = "Brosse a dents", resellerValue = 50, timeToTake = 2 },
        ["SECHECHEVEUX"] = { name = "Seche Cheveux", resellerValue = 50, timeToTake = 3 },
        ["LIVRES"] = { name = "Livres", resellerValue = 200, timeToTake = 8 },
...
bijouterie = {
    ...
    items = {
        ["DIAMAND"] = {name = "Diamand", resellerValue = 2, timeToTake = 25},
        ["BIJOUX"] = {name = "Bijoux", resellerValue = 1, timeToTake = 20},
    },
    ...
    houses = {	
        ...
        {	
            name = "Bijouterie", 	
            authority = "police",	
            timeToGoToReseller = 45, -- minutes	
            copsCalledAfter = 1,  -- s	
            policeBlipDuration = 500, -- s	
            maximumTime = 560,  -- s	
        ...
        {	
            name = "Bijouterie Paleto", 	
            authority = "police",	
            timeToGoToReseller = 20, -- minutes	
            copsCalledAfter = 1,  -- s	
            policeBlipDuration = 320, -- s	
            maximumTime = 140,  -- s	
            interiorVector = vector3(-382.0233, 6043.9590, 31.5094), 	
            exitVector = vector3(-382.0233, 6043.9590, 31.5094),
            outdoorVector = vector3(-382.0233, 6043.9590, 31.5094), 	
            objects = {	
                {object = "DIAMAND", position =  vector3(-379.5216, 6049.5386, 31.5094)},	
                {object = "BIJOUX", position = vector3(-379.4088, 6047.9150, 31.5094)},	
                {object = "DIAMAND", position = vector3(-380.2621, 6047.1245, 31.5094)},	
                {object = "BIJOUX", position = vector3(-378.9042, 6045.7876, 31.5094)},
                {object = "DIAMAND", position =  vector3(-377.9731, 6046.7031, 31.5094)},	
                {object = "BIJOUX", position = vector3(-376.7099, 6046.2578, 31.5094)},	
                {object = "DIAMAND", position =  vector3(-377.4401, 6043.6523, 31.5094)},	
                {object = "BIJOUX", position = vector3(-378.3203, 6042.6279, 31.5094)},	
            },	
        },
        {	
            name = "Bijouterie Grappe Seed", 	
            authority = "police",	
            timeToGoToReseller = 20, -- minutes	
            copsCalledAfter = 1,  -- s	
            policeBlipDuration = 320, -- s	
            maximumTime = 140,  -- s	
            interiorVector = vector3(1652.0011, 4882.7490, 42.1604), 	
            exitVector = vector3(1652.0011, 4882.7490, 42.1604),
            outdoorVector = vector3(1652.0011, 4882.7490, 42.1604), 	
            objects = {	
                {object = "DIAMAND", position =  vector3(1650.0903, 4885.9180, 42.1604)},	
                {object = "BIJOUX", position = vector3(1648.7794, 4885.7959, 42.1604)},	
                {object = "DIAMAND", position = vector3(1648.7031, 4883.1865, 42.1604)},	
                {object = "BIJOUX", position = vector3(1647.4211, 4882.9004, 42.1604)},
                {object = "DIAMAND", position =  vector3(1646.4108, 4884.0317, 42.1604)},	
                {object = "BIJOUX", position = vector3(1648.9556, 4881.2783, 42.1604)},	
                {object = "DIAMAND", position =  vector3(1647.8452, 4881.1387, 42.1604)},	
                {object = "BIJOUX", position = vector3(1647.0496, 4879.7861, 42.1604)},	
            },	
        },	
    },
}
