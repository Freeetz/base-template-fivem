...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "Freetz Commumenu", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "Freetz Commumenu", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}
