---@type table
local Colour = {
    Background = { Dictionary = "Freetz Commumenu", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "Freetz Commumenu", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "Freetz Commumenu", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
    Header = { X = 230.5, Y = 15, Scale = 0.35 },
