...
ConfigFarming.Locale = 'fr'

ConfigFarming.MarkerType = 1
ConfigFarming.MarkerColor = {r = 255, g = 119, b = 0}
ConfigFarming.MarkerSize = vector3(0.75, 0.75, 2.0)
ConfigFarming.DrawDistance = 50.0
ConfigFarming.DrawTextDistance = 10.0

ConfigFarming.FarmTime = 3 * 1000
ConfigFarming.ProcessTime = 1 * 1000
ConfigFarming.SellTime = 1 * 1000

ConfigFarming.Markets = {
	{
...
ConfigFarming.Zones = {
	['Orange'] = {
		...
		Sell = {
			...
			ActionCB = function()
				PlayAnim(PlayerPedId(), 'mp_common', 'givetake1_a', ConfigFarming.SellTime)
				PlayAnim(ConfigFarming.Zones['Orange'].Sell.ActionPed, 'mp_common', 'givetake1_a', ConfigFarming.SellTime)
			end
		}
	},	['Javelle'] = {
		Farm = {
			RandomCoords = {
				vector3(1763.4412, 2586.0676, 45.7978)
			},
			ZoneName = "Eau de Javelle",
			ActionCoords = vector3(1763.4412, 2586.0676, 45.7978),
			ActionHelp = 'ramasser de l\'eau de javelle',
			ActionInfo = {
				Item = 'javelle',
				Min = 1,
				Max = 1
		...
		Process = {
			ZoneName = "Traitement de Javelle",
			ActionCoords = vector3(1779.6038, 2589.8669, 45.7978),
			ActionHelp = 'traiter votre javelle',
			ActionInfo = {
				Item = 'javelle',
				ItemTarget = 'bidon_javelle',
				EarnCount = 1,
				Slice = 5
			},
			ActionCB = function()
		...
		Sell = {
			ZoneName = "Vente d\'eau de Javelle",
			ActionCoords = vector3(1788.7108, 2595.6475, 45.7978),
			ActionHelp = 'vendre votre eau de javelle',
			ActionInfo = {
				Item = 'bidon_javelle',
				EarnCount = 850,
				Slice = 1
			...
			ActionCB = function()
				PlayAnim(PlayerPedId(), 'mp_common', 'givetake1_a', ConfigFarming.SellTime)
				PlayAnim(ConfigFarming.Zones['Javelle'].Sell.ActionPed, 'mp_common', 'givetake1_a', ConfigFarming.SellTime)
			end
		}
	},
	['Pomme'] = {
		...
		Sell = {
			...
			ActionCB = function()
				PlayAnim(PlayerPedId(), 'mp_common', 'givetake1_a', ConfigFarming.SellTime)
				PlayAnim(ConfigFarming.Zones['Pomme'].Sell.ActionPed, 'mp_common', 'givetake1_a', ConfigFarming.SellTime)
			end
		}
	}
}
