...
function UIMenuItem.New(Text, Description)
    local _UIMenuItem = {
        ...
        SelectedSprite = Sprite.New("Freetz Commumenu", "gradient_nav", 0, 0, 431, 38),
        LeftBadge = { Sprite = Sprite.New("Freetz Commumenu", "", 0, 0, 40, 40), Badge = 0 },
        RightBadge = { Sprite = Sprite.New("Freetz Commumenu", "", 0, 0, 40, 40), Badge = 0 },
        Label = {
