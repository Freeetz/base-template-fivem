...
function UIMenuColourPanel.New(Title, Colours)
    local _UIMenuColourPanel = {
        ...
        Background = Sprite.New("Freetz Commumenu", "gradient_bgd", 224, 50, 50, 255),
        Bar = {},
        EnableArrow = true,
        LeftArrow = Sprite.New("Freetz Commumenu", "arrowleft", 0, 0, 30, 30),
        RightArrow = Sprite.New("Freetz Commumenu", "arrowright", 0, 0, 30, 30),
